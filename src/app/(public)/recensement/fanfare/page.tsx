  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center px-4 py-8 md:py-12 overflow-y-auto">
        ...
        <div className="my-auto shrink-0 w-full max-w-2xl bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl shadow-emerald-900/5 border border-white/50 p-5 sm:p-8 md:p-12 relative">
